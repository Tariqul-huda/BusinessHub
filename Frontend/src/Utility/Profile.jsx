...
const Profile = ({userID=null})=>{
    ...
    if(currentUser.user.role!=="admin" && currentUser.user.role!=="hr"){
        ...
        return <div className="p-8 text-center text-gray-500 uppercase">you do not have access</div> 
    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:px-4">
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <div className="space-y-1">
                  ...
                  <InfoItem label="Phone" value={user.phone || user.phoneNumber} />
                </div>
              </div>
              {/* right section */}
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <div className="space-y-1">
                  ...
                  <InfoItem label="Salary" value={user.salary ? `$${user.salary.toLocaleString()}` : null} />
                  <InfoItem label="Joined Date" value={user.dateOfJoining} />
                  <InfoItem label="Status" value={user.status} isStatus={true} />
                </div>
              </div>
            </div>
